...
- [5.2.1 Add SPICE Code](#521-add-spice-code)
- [5.2.2 Include the Model Directory](#522-include-the-model-directory)
- [5.2.3 Setting Up the Control Commands](#523-setting-up-the-control-commands)
- [5.2.4 Generate Netlist](#524-generate-netlist)
- [5.2.5 Simulate](#525-simulate)
...
<figure>
  <img src="./images/code_shown.png" alt="Code Block" width="400">
...
<figure>
  <img src="./images/code_shown_attributes.png" alt="Code Block Attributes" width="400">
...
<figure>
  <img src="./images/include.png" alt="Include Library" width="400">
...
For more control commands, please refer to the [SPICE Quick Reference Sheet v1.0](https://web.stanford.edu/class/ee133/handouts/general/spice_ref.pdf).
...
<figure>
  <img src="./images/control.png" alt="Control Commands" width="400">
...
<figure>
  <img src="./images/codes.png" alt="W/L ratios" width="400">
...
<figure>
  <img src="./images/set_netlist_to_show.png" alt="Show Netlist" width="400">
...
<figure>
  <img src="./images/simulation_options.png" alt="Simulation Options" width="400">
...
<figure>
  <img src="./images/netlisteg.png" alt="Example Netlist" width="400">
...
<figure>
  <img src="./images/after_hit_sim.png" alt="Simulation Output" width="400">
...
<figure>
  <img src="./images/plot.png" alt="Plot Result" width="400">
