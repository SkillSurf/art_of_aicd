...
- **Low-Voltage MOSFETs (1.5 V)**
  - `sg13_lv_nmos`: $$V_{th}$$ ~ 0.5 V, Lmin = 0.13 µm
  - `sg13_lv_pmos`: $$V_{th}$$ ~ -0.47 V, Lmin = 0.13 µm

- **High-Voltage MOSFETs (3.3 V)**
  - `sg13_hv_nmos`: $$V_{th}$$ ~ 0.7 V, Lmin = 0.45 µm
  - `sg13_hv_pmos`: $$V_{th}$$ ~ -0.65 V, Lmin = 0.45 µm
