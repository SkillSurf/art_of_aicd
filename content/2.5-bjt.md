...
<figure>
  <img src="./images/basic_models/BJT_Cross_Section.jpg" alt="BJT IC implementation" width="500">
  <figcaption><em>Figure 2.5.3: IC level implementation of a BJT (cross-sectional view)
  
  (Brian, “How a BJT Works. Working w Bipolar Junction Transistors | Circuit,” Circuit Crush. Available: https://www.circuitcrush.com/how-bjt-works/)
).</em></figcaption>
</figure>
