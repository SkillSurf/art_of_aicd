...
$$C_{ox}$$ is the capasitance of the unit block.

The following image shows scaned image of a manufactured capasitor cros-section view.

<figure>
  <img src="./images/basic_models/cap_scanned.png" alt="Resistor V-I curve" width="500">
  <figcaption><em>Figure 2.1.5: scaned cross section view of a capasitor.
  </em></figcaption>
</figure>