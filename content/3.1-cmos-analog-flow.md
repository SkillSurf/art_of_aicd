...
<div align="center">
  <table>
    <tr>
      ...
      <td>
        <img src="./images/inverter_xschem.jpg" alt="CMOS Inverter in Xschem" width="300"/>
      </td>
      <td>
        <img src="./images/inverter_layout.jpg" alt="CMOS Inverter Layout View" width="250"/>
      </td>
    </tr>
  </table>
...
Basically there’s a number of different ways to implement digital logic. Each has their advantages and disadvantages. CMOS tends to be the favourite these days due to its low power. Before we can create a silicon-based inverter, we think you have a basic understanding of inverter design in terms of physical components. This typically consists of one NMOS and PMOS transistor. 
