...
This is how you connect the PMOS (top) and NMOS (bottom) transistor cells together in your layout, and also connect the VDD and GND power rails to create the inverter layout. The "In" and "Out" labels indicate the INPUT and OUTPUT.

<div align="center">
  <img src="./images/layout/inv_layout.png" alt="CMOS  inverter using Klayout" width="500"/>
